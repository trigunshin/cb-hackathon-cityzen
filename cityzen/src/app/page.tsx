...
const METRALL_INFO = {
  left: {
    title: "Simplifying civic engagement in LA. Your city's pulse, at your fingertips.",
    description: "Metrall empowers residents of Los Angeles by offering easy access to the latest local news, events, and civic activities. With AI-driven insights, Metrall keeps you informed on important community matters, from city council meetings to public events, all in one intuitive platform. Stay connected to the pulse of your neighborhood and make informed decisions about your city."
  },
  right: {
    title: "Empowering informed communities through AI-driven insights.",
    description: "Metrall is more than just a news aggregator; it brings together real-time data from various sources, including city governance updates, local events, and social causes, offering personalized information based on your interests and location. Whether it's attending a neighborhood council meeting or learning about a new policy affecting your area, Metrall makes civic participation accessible for everyone."
  }
};
  ...
  return (
    ...
    <Box
      ...
      <Box sx={{ width: '100%', bgcolor: 'white' }}>
        <Container sx={{ py: 4 }}>
        <Typography paddingY={5} variant="h4" textAlign={'center'} color='#72BAE3'>
